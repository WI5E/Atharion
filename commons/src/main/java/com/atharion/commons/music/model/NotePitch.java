...
public enum NotePitch {
	...
	private static final NotePitch[] VALUES = NotePitch.values();
	private static final int CACHED_SIZE = VALUES.length;
	...
	public static NotePitch get(int key) {
		return key >= CACHED_SIZE ? NotePitch.NOTE_00 : VALUES[key];
	}
}